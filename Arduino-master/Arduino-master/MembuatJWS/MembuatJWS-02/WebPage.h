...
<table width='100%'>
  <tr>
    <td>
      <label for="delayjumat">Durasi Jumat</label><br>
      <input id="delayjumat" placeholder="30" maxlength="2" size="3"/>
    </td>
    <td>
      <label for="kecerahan">Kecerahan Layar</label><br>
      <input id="kecerahan" placeholder="30" maxlength="3" size="3"/>
    </td>
  </tr>
</table>
...
<table width='100%'>
  <tr>
    <td>
      ...
      <input id="latitude" placeholder="-1.2603995106966508" size="9"/>
    </td>
    <td>
      <label for="longitude">Longitude</label><br>
      <input id="longitude" placeholder="116.89451868938446" size="9"/>
    </td>    
  </tr>
  <tr>
    <td>
      <label for="zonawaktu">Zona Waktu</label><br>
      <input id="zonawaktu" placeholder="8" size="3"/>
    </td>
    <td>
...
<form>
  ...
  <div>
    <label for="textstliqomah">Teks Setelah Iqomah</label><br>
    <textarea rows="3" id="textstliqomah" placeholder="Luruskan dan Rapatkan Shaf"/></textarea>
  </div>
  <div>
    <br>
    <button onClick="setJws()"> Simpan </button>
...
<hr/>
<br><br>
<a class ='tombol' href="http://facebook.com/lha.acim">Copyright (c) 2021</a><br><br><br>
...
function handleServerResponseDataJWS(){
 ...
 if(xmlHttp.readyState==4 && xmlHttp.status==200){
   ...
   xmldoc = xmlResponse.getElementsByTagName('DelayJumat');
   message = xmldoc[0].firstChild.nodeValue;
   document.getElementById('delayjumat').value=message;
   ...
   xmldoc = xmlResponse.getElementsByTagName('TextStliqomah');
   message = xmldoc[0].firstChild.nodeValue;
   document.getElementById('textstliqomah').value=message;
 }
...
function setJws() {
  ...
  var delayjumat    = document.getElementById("delayjumat").value;
  ...
  var textstliqomah = document.getElementById("textstliqomah").value;
  
  var datajws = {iqmhs:iqmhs, iqmhd:iqmhd, iqmha:iqmha, iqmhm:iqmhm, iqmhi:iqmhi, durasiadzan:durasiadzan, ihti:ihti, latitude:latitude, longitude:longitude, zonawaktu:zonawaktu, hilal:hilal, namamasjid:namamasjid, textstliqomah:textstliqomah, kecerahan:kecerahan, delayjumat:delayjumat};
